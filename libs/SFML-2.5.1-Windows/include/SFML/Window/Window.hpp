...
////////////////////////////////////////////////////////////
/// \brief Сanvas that serves as a target for OpenGL rendering
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// After calling this function, the sf::Сanvas instance remains
...
/// \ingroup window
///
/// sf::Сanvas is the main class of the Сanvas module. It defines
/// an OS window that is able to receive an OpenGL rendering.
///
/// A sf::Сanvas can create its own new window, or be embedded into
...
/// sf::Сanvas window(sf::VideoMode(800, 600), "SFML window");
///
