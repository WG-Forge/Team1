...
class State
{
  ...
  public:
    ...
    void AddInformation(float x, float y, const std::string &title, const std::string &fontName, int size,
                        sf::Color color);
    ...
    void AddText(float x, float y, const std::string &title, const std::string &fontName, int size, sf::Color color);
